...
\NewDocumentCommand{\graybox}{ m }{\colorbox{lightgray}{$#1$}}
...
\inference[T-FINISH]{\Gamma; ocap \vdash t : \tau}{\Gamma; a \vdash \mathit{finish} \{ t \} : null}
\inference[]{}{}
...
\subsubsection{Other}
\inference[ACC-F]{x \rightarrow o \in L \vee ((x \rightarrow b(o,p) \in L \vee \graybox{x \rightarrow task(b(o,p),t)}) \wedge p \in P)}{accRoot(o, \langle L, t, P \rangle ^ l)}
\inference[]{}{}
\inference[ACC-FS]{accRoot(o, F) \vee accRoot(o, FS)}{accRoot(o, F \circ FS)}
\inference[]{}{}
\inference[ISO-FS]{\forall o, o' \in dom(H). (accRoot(o, FS) \wedge accRoot(o', FS')) \Rightarrow sep(H, o, o')}{isolated(H, FS, FS')}
\inference[]{}{}
