...
\alttitle{Ett typsystem för säker och strukturerad }
...
\section{Concurrent Determinism}
\chapter{Related Work}
\section{LaCasa}
\section{DPJ}
\section{Rust}
\section{Deterministic Concurrency Using Lattices}
...
% \include{tex/proposed_extension}
